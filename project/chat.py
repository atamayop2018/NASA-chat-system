...
# Load .env (OPENAI_API_KEY, OPENAI_BASE_URL for Vocareum proxy, etc.) before importing
# any module that constructs OpenAI / langchain clients at import time.
try:
    ...
    with st.sidebar:
        ...
        if not available_backends:
            ...
            st.info(
                ...
                "`python embedding_pipeline.py --openai-key $OPENAI_API_KEY "
                "--data-path ./data_text`"
            )
            st.stop()
